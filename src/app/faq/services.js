...
angular.module('inspinia').service('faqService', ['$q', '$http', 'configurationService', function ($q, $http, configurationService) {
    ...
    this.getList = function () {
        var D = $q.defer()
        $http.get(configurationService.baseUrl() + '/lists?filter[where][name]=faqs').success(function (data) {
            // console.log(data);
            // console.log('#######');
    ...
    //     return D.promise;
    // }
    this.updatefaq = function (id, data) {
        var D = $q.defer()

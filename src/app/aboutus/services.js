...
angular.module('inspinia').service('aboutusService', ['$q', '$http', 'configurationService', function ($q, $http, configurationService) {
    ...
    this.getList = function () {
        var D = $q.defer()
        $http.get(configurationService.baseUrl() + '/lists?filter[where][name]=aboutUs').success(function (data) {
            console.log(data);
            // console.log('#######');
    ...
    this.updateAboutus = function (id, data) {
        var D = $q.defer()

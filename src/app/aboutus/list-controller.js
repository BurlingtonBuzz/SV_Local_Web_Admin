...
angular.module('inspinia')
    .controller('aboutusctrl', function ($scope, $state, aboutusService, toaster, $stateParams,configurationService) {
        var vm = this;
        ...
        $scope.getList = function () {
            aboutusService.getList().then(function (data) {

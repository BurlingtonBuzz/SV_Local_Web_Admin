...
angular.module('inspinia')
    .controller('supportctrl', function ($scope, $state, supportService, toaster, $stateParams,configurationService) {
        var vm = this;
        ...
        $scope.getList = function () {
            supportService.getList().then(function (data) {

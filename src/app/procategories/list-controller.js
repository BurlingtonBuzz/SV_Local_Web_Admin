...
angular.module('inspinia')
    .controller('prosubcategoriesListCtrl', function ($scope, $state, categoryService,prosubcategoryService, toaster, $stateParams) {
        var vm = this;
        // get user list api start here
        // $scope.getprocategory = function () {
        //     prosubcategoryService.getList().then(function (procategory) {
        ...
        // }
            ...
            $scope.getprosubcategory = function () {
                prosubcategoryService.getList().then(function (procategory) {
                    console.log(procategory);
                    $scope.listsubproCategory = procategory.result.list;
                });
            }
        ...
        $scope.delete = function (id) {
            prosubcategoryService.deleteCategory(id).then(function (data) {
        ...
        $scope.edit = function (id) {
            ...
            $state.go('procategories.updateProSub', {
                id: id
            });
        }

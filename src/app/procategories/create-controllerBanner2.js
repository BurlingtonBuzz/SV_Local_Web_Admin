...
angular.module('inspinia')
    .controller('advertisementCreateCtrl2', function($scope, $state,  advertisementService, toaster, FileUploader, configurationService, $stateParams, $filter) {
        ...
        var dealPhoto = $scope.dealPhoto = new FileUploader({
            ...
            dealPhoto.onSuccessItem = function(item, response, status, headers) {
                ...
                if ($scope.img.result.result.files.file[0].name == undefined) {
                    ...
                    var obj= {"imageURL":imageURL, 'index': $scope.bannernumber} ;
                    ...
                    advertisementService.addadvertisement(obj).then(function (data) {
                        ...
                        $scope.dealsimage = null;
                        $scope.dealAddPhoto = null;
                        $scope.bannernumber = "";
                        //$state.go('deals');
